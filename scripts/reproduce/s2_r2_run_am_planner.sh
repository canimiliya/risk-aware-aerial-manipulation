...
variant="${1:?usage: s2_r2_run_am_planner.sh smoke_free|loose|nominal|narrow run-id timeout-s}"
...
run_dir="$repo/docs/evidence/S2-R2/runtime/$run_id"
...
launch_file="$repo/planner_bridge/scenes/s2_r2_official.launch"
